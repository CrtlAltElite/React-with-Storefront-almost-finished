    ...
    return (
      <div>
        ...
        <Switch>
          ...
          <ProtectedRoute token={this.state.token} exact path = "/shop" render={()=><Shop/>}/>
          <ProtectedRoute token={this.state.token} exact path = "/item:id" render={(props)=><SingleItem {...props} />}/>
